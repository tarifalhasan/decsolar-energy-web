    ...
    <Layout>
      <div className="ml-[334px]">
        ...
        <div className="main-content  gap-5 flex p-4 flex-col flex-grow ">
          <div className="bg-white max-w-[921px] rounded-[5px]">
            {payBilling.map((data, i) => (
              <div key={i} className="px-5  py-8">
                <h1 className="text-[#333333] pb-5 border-b border-slate-600 text-[1.563em]">
                ...
                <div className="border-b-4 pb-3 border-skin-green">
                  <div className="flex   items-center w-[80%] justify-between">
                    <h2 className="text-xl">{data.billlingAddress}</h2>
                    <address className="text-skin-muted">
                      {data.address}
                    </address>
                  </div>
                </div>
                <div className="my-10">
                  ...
                  <div className=" flex items-center justify-between w-[60%]">
                    <h2 className="text-xl">Total Cost Electricity Bill </h2>
                    <span className="text-skin-muted">
                ...
                <div
                  className="btn-group flex px-10 justify-between items-center
              "
                >
